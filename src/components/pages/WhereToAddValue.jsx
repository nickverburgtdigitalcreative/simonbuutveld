                    ...
                    <div className='scroller'>
                        ...
                        <div className="page">
                            ...
                            <div className="paragraph">
                                <p>This graph shows a broad and simplified but typical customer journey, from discovering and selecting an Architect to their occupation of the home. Because the primary area of interest is in the first phase of this journey which is the Design and Costing phase, this part of the graph has been expanded.</p>
                                <p>This journey is applicable for a Developer coming to an Architect as well. It is true if the design is bespoke or a change to an existing plan.</p>
                                <p>The red line indicates the ups and downs the customer experiences during the process. Obviously during the process there are moments where the customer feels good and bad. These moments have an effect on the customer's compliancy. That is how easy they are to deal with and how likely or unlikely they are to comply with the Architect's wishes. For example, a high level of compliancy can mean a customer says yes to a more expensive material the Architect thinks will work best. And a low compliancy can mean excessive design changes that cost time and money.</p>
                                <p>As indicated, the lowest point during this process occurs at the initial design presentation. It is here that the process needs the most help. So it is here that the most value can be added.</p>
                                <p>Adding value to this area also indicates that the subsequent areas will also see improvement. This is because each time the customer has a positive experience, they look forward to the next one. This means they enter each meeting with a positive mindset, that continues to build.</p>
                            </div>
