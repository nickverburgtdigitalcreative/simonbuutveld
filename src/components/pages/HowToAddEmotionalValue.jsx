                ...
                <div id="subpage">
                    ...
                    <div className='scroller'>
                        ...
                        <div className="page">
                            ...
                            <div className="paragraph"><p className="redxl">For someone to form an emotional connection to something, it needs to have a human element to it they can connect with.</p><p>The two images below show two robots. But only one has been given qualities that allow a person to make an emotional connection with it.</p></div>
                            ...
                            <div className="paragraph">
                                ...
                                <p>However care needs to be taken this process doesn’t become so loose and amorphous that confusion arises over exactly what is being proposed. This can be a problem with traditional basic freestyle sketches. This again is a huge turn off for the customer as they will become so removed from the process they remove the process all together!</p>
                                <p className="redxl">But something needs to be shown at this stage for the customer to form an emotional connection too.</p>
                                <p>They need to be shown something that is an accurate depiction of the proposed design but still loose enough that they can enjoy it without getting stuck on details they may be unsure of.</p>
                                <p className="redxl">How is something shown that is technically accurate but loose at the same time?</p>
                                <p className="redxl">And of course something people can inherently develop an emotion connection with?</p>
                            </div>
                            <div className="top2">
                                <div className="col2">
                                    <div className="t1"><strong>How</strong> to add value</div>
                            ...
                            <div className="paragraph para_outro">
                                <p>In the context as it is being desribed here, it is a human to human connection between the Architect and the potential buyer, describing a subject very important to both of them. It is a very human/primal method of communication that is accessible to everyone but controlled by one.</p>
                            </div>
                            <div className="top2">
                                <div className="col2">
                                    <div className="t1"><strong>How</strong> to add value</div>
